...
browserOpenPromise
  ...
  function getCode(){
    ...
    .then(function(allCodeNamesElement){
      // [<h3>C++</h3> , <h3>Python</h3> , <h3>Java</h3> ]--> getting all heading tags from editorial
      ...
      // allCodeNamesPromise = [Promise<data> , Promise<data> , Promise<data> ]--> all the promises
...
function pasteCode(){
  return new Promise(function(scb,fcb){
    ...
    .then(function(){
      return tab.keyboard.donw("Control");
    })
    .then(function(){
